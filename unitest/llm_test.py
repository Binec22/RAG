...
from LLM import LLM, APIKeyMissingError, TemperatureInvalidValue, UnknownModelException
...
class TestLLM(unittest.TestCase):
    ...
    def test_invalid_temperature(self):
        with self.assertRaises(TemperatureInvalidValue):
            LLM(model_name='gpt-3.5-turbo', load=False, temperature=1.5)
